...
export default function AddRelativeModal({ personAId, isOpen, onClose }: AddRelativeModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg border-2 border-blue-500">
        <div className="bg-gradient-to-r from-blue-500 to-blue-600 px-6 py-4 rounded-t-lg">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-blue-100 text-sm">Connect to an existing person in your family tree</p>
            </div>
          </div>
        </div>
